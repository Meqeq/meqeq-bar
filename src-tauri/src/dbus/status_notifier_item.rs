...
pub trait StatusNotifierItem {
    ...
    #[zbus(signal)]
    fn new_icon_theme_path(&self) -> zbus::Result<()>;
    ...
    fn xayatana_new_label(&self, label: &str, guide: &str) -> zbus::Result<()>;
    ...
    fn xayatana_label(&self) -> zbus::Result<String>;

    /// XAyatanaLabelGuide property
    #[zbus(property, name = "XAyatanaLabelGuide")]
    fn xayatana_label_guide(&self) -> zbus::Result<String>;
}
